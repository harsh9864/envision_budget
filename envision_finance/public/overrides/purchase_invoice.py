...
class PurchaseInvoice(BuyingController):
            ...
            for budget in budget_all_data:
                if budget.item == item.item_code:
                    ...
                    if budget.current_budget < item.amount:
                        ...
                        if budget.get('action_if_annual_budget_exceeded_on_pi') == "Stop":
                        ...
                        elif budget.get('action_if_annual_budget_exceeded_on_pi') == "Warn":
                            frappe.msgprint(
    ...
    def budget_data(self,project,company,department):
        ...
        budget_data_sql = f"""
            ...
            SELECT 
                IB.name,
                IB.action_if_annual_budget_exceeded_on_pi,
                BI.item,
                BI.amount,
                BI.current_budget,
                BI.quantity,
            ...
            WHERE IB.applicable_on_purchase_invoice = 1
            AND IB.docstatus = 1
            AND IB.is_used = 1
            AND IB.disable = 0
    ...
    def updating_the_budget_data_after_cancellation(self):
            ...
            budgets = frappe.db.sql("""
                ...
                FROM `tabItem wise Budget Logs` AS IBL
            ...
            for budget in budgets:
                ...
                for log in project_budget.logs:
                    if log.entry_type == "Purchase Invoice" and log.id == self.name:
